...
echo "=> Cleaning up..."
sudo apt-get autopurge docker-{buildx-plugin,ce{,-cli}} containerd.io podman buildah skopeo containers-common kubectl \
...
ubuntu-mono *-icon-theme esl-erlang imagemagick{,-6-common} libgl1-mesa-dri firebird* hhvm >> /dev/null
